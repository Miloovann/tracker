...
with open("/Users/junyiho/Desktop/PW_Web/" + 'metersworld.csv','w',newline='')as f:
    writer = csv.writer(f)
    for row in table.find_all('tr'):
        ...
        for data in row.find_all('td'):
            ...
            if rowedit == True or buffer == 'Total:' or (buffer == '' and check == 0):# last condition is to remove rows that have an empty first column
                ...
                if (check > 0 and check < 7) or check == len(row.find_all('td'))-4:
                    buffer = buffer.replace(",","")
...
result = r.json()
with open("/Users/junyiho/Desktop/PW_Web/" + 'tracker.csv','w',newline='')as f:
    writer = csv.writer(f)
...
sortcountries("/Users/junyiho/Desktop/PW_Web/tracker.csv")
sortcountries("/Users/junyiho/Desktop/PW_Web/livencov.csv")
sortcountries("/Users/junyiho/Desktop/PW_Web/metersworld.csv")
...
with open("/Users/junyiho/Desktop/PW_Web/" + filedate + "all.csv","w",newline = '')as final:
    w = csv.writer(final)
    w.writerow(head)
    with open("/Users/junyiho/Desktop/PW_Web/livencov.csv","r",newline='')as fone:
        readerone = list(csv.reader(fone))
        with open("/Users/junyiho/Desktop/PW_Web/tracker.csv","r",newline='')as ftwo:
            readertwo = list(csv.reader(ftwo))
            with open("/Users/junyiho/Desktop/PW_Web/metersworld.csv","r",newline='')as fthree:
...
with open("/Users/junyiho/Desktop/PW_Web/" + filedate + "logall.csv","w",newline='')as flog:
    writer = csv.writer(flog)
    with open("/Users/junyiho/Desktop/PW_Web/" + filedate + "all.csv",'r')as foriginal:
...
def SortSplitContinents(csvname):
    f = open("/Users/junyiho/Desktop/PW_Web/" + filedate + csvname, 'r')
    data = [line for line in csv.reader(f)]
    data.sort(key=itemgetter(6))
    names = ["africa","asia","australiaoceania","europe","northamerica","southamerica"]
    cont = names.copy()
    for i in range(len(names)):
        names[i] = open("/Users/junyiho/Desktop/PW_Web/" + filedate + names[i] + csvname, 'w+')
...
def graphbarh(colnum, casetype, casesave):
    for x in range(len(csvfilenames)):
        with open("/Users/junyiho/Desktop/PW_Web/" + filedate + csvfilenames[x], 'r') as f:
            data, world = [],[]
        ...
        hightotal.savefig("/Users/junyiho/Desktop/PW_Web/" + countrynames[x] + casesave, format='svg', bbox_inches='tight', transparent=True)
...
def singaporegraphs(ynumb, titlename, figurename):
    ...
    SG.set_ylim(ymin=0)
    ALLSG.savefig("/Users/junyiho/Desktop/PW_Web/" + figurename, format='svg', bbox_inches='tight', transparent=True)
...
for i in range(len(total)):
          ...
          circle.savefig("/Users/junyiho/Desktop/PW_Web/" + "SG " + dates[i] + " Cases.svg", format = "svg", bbox_inches='tight', transparent=True)
##End Singapore Graphs

with open("/Users/junyiho/Desktop/PW_Web/updatetiming.txt", 'w') as f:
